...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	if(mouseColor == end) {
		JOptionPane.showMessageDialog(null, "You won! Good job... I guess?");
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("371708__darkmime__squeaky-jumpscare-2.wav"));
	...
	private void showScaryImage(String imageName) {
		try {
			maze = ImageIO.read(getClass().getResource("Yeet.gif"));
		} catch (Exception e) {
